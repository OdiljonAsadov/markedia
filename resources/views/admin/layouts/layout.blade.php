<html lang="en" style="height: 400px;"><head>
    <meta charset="utf-8">
  ...
  <body class="sidebar-mini" style="height: 400px;">
  <!-- Site wrapper -->
  <div class="wrapper">
    <!-- Navbar -->
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                {{-- <li class="nav-item">
                  <a href="{{ route('categories.edit', ['category' => $category->id]) }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Edit category</p>
                  </a>
                </li> --}}
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                {{-- <li class="nav-item">
                  <a href="{{ route('tags.edit', ['tag' => $tag->id]) }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Edit category</p>
                  </a>
                </li> --}}
